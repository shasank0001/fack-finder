...
const faqData = [
  {
    question: "How accurate is FactSniff's AI detection?",
    answer: "FactSniff uses advanced machine learning algorithms with an average accuracy rate of 94-98% across different content types. Our models are continuously updated with the latest detection techniques and trained on millions of data points."
  },
  {
    question: "What types of content can FactSniff analyze?",
    answer: "FactSniff can analyze fake news articles, fraudulent e-commerce sites, scam job postings, manipulated social media content, AI-generated images, deepfake videos, and AI-written text. We support URLs, direct text input, and file uploads."
  },
  {
  ...
  {
    question: "Can I use FactSniff for commercial purposes?",
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-lg">
              Get answers to common questions and learn how to use FactSniff effectively
            </p>
          </div>
        </div>
        ...
        <Card className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-sm border-white/20">
          <CardHeader>
            ...
            <CardDescription>
              Get up and running with FactSniff in minutes
            </CardDescription>
          </CardHeader>
