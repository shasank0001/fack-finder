...
const mockResults = [
  {
    id: '1',
    type: 'Fake News',
    content: 'Breaking: Major Political Announcement Rocks the Nation',
    url: 'https://suspicious-news-site.com/article',
    verdict: 'Fake',
    riskScore: 92,
  ...
  },
  {
    ...
    url: 'https://luxury-deals-store.com',
    verdict: 'Suspicious',
    riskScore: 78,
  ...
  },
  {
    id: '4',
    type: 'Job Posting',
    content: 'Remote Data Entry - $5000/month',
    url: 'https://quickjobs.com/remote-data-entry',
    verdict: 'Scam',
    riskScore: 88,
  ...
  },
  {
    id: '5',
    type: 'Social Media',
    content: 'Viral tweet about cryptocurrency investment',
  ...
  },
  {
    id: '6',
    type: 'AI Text',
    content: 'Academic essay about climate change impacts...',
    url: null,
    verdict: 'AI Generated',
    riskScore: 85,
  ...
  },
  {
    id: '7',
    type: 'Video Content',
    content: 'Political figure speech analysis',
    url: 'https://youtube.com/watch?v=example',
    verdict: 'Suspicious',
    riskScore: 72,
    timestamp: '2024-01-12T20:10:00Z',
    icon: '🎞️'
  }
];
                  ...
                  <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center gap-4 ml-4">
                      ...
                      <div className="flex gap-2">
                        ...
                        <Button variant="ghost" size="sm" className="hover:bg-red-100 dark:hover:bg-red-900/20 text-red-600">
