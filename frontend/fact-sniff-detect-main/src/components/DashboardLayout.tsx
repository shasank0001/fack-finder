...
const sidebarItems = [
  ...
  { icon: AlertTriangle, label: "Fake E-commerce", path: "/fake-ecommerce" },
  { icon: Search, label: "Scam Jobs", path: "/scam-jobs" },
  { icon: MessageSquare, label: "Fake Tweets", path: "/fake-tweets" },
  { icon: Image, label: "AI Images", path: "/ai-images" },
  { icon: FileText, label: "AI Text", path: "/ai-text" },
